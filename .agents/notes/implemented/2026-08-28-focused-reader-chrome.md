...
The later [reader panel defaults](2026-08-31-reader-panel-defaults.md) decision reverses the thumbnail rail's initial visibility while preserving the focused top strip and on-demand panel controls.
