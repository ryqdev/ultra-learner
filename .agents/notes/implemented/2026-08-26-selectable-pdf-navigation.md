...
- Thumbnail scrolling and keyboard navigation are deterministic and covered by helper tests; browser layout and selection still require a real browser check when one is available.
